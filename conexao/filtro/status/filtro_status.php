<?php
  ...
  include 'cont_status.php';

?>


<ul class="list-unstyled d-block position-static shadow d-grid gap-12 col-12 col-md-12">
  <li>
  ...
  <li>
    <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="painel_chamado.php?status=Não%20Impor/Não%20Urgen">
      <span class="d-inline-block bg-info rounded-circle p-1">(<?php echo $n_imp_n_urg; ?>)</span>
      Não Impor/Não Urgen
    </a>
  </li>
  <li>
    <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="painel_chamado.php?status=Não%20Impor/Urgente">
      <span class="d-inline-block bg-primary rounded-circle p-1">(<?php echo $n_imp_urg; ?>)</span>
      Não Impor/Urgente
    </a>
  </li>
  <li>
  ...
  <li>
    <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="painel_chamado.php?status=Finalizado">
      <span class="d-inline-block bg-success rounded-circle p-1">(<?php echo $finalizados; ?>)</span>
      Finalizado
    </a>
  </li>
</ul>